...
let race=prompt("What race is your character? (Human, Elf, Troll, Hybrid)");
let characterRole=prompt("What class is your character? (Warrior, Mage, Knight, Thief, Hunter)");
